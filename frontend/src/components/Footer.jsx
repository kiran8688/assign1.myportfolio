...
const Footer = () => {
  return (
    <footer id="footer" className="bg-background py-16 text-center text-secondary border-t border-white/10 lg:ml-[100px] relative overflow-hidden">
      {/* Abstract background accents & Geometric Elements */}
      ...
      <div className="absolute bottom-10 left-10 w-32 h-32 border border-primary/10 rotate-12 pointer-events-none -z-0"></div>
      <div className="absolute top-10 right-10 w-40 h-40 border border-primary/5 rounded-full pointer-events-none -z-0"></div>

...
// Performance optimization: Memoize individual dock items to prevent
// re-rendering all 6 items when only 1 or 2 actually change active state
...
const NavigationDock = ({ activeSection }) => {
  // Memoize the array definition so it isn't recreated on every render

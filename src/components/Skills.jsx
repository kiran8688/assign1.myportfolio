        ...
        <div className="mt-16 flex flex-wrap justify-center gap-6">
          {skillsList.map((skill, idx) => (
            <motion.div
              ...
              className="group flex items-center justify-center gap-6 px-10 py-6 glass-card-skills cursor-default"
            >
              <div className="flex-shrink-0 flex items-center justify-center">
                {skill.icon}
              </div>

              <h3 className="text-white font-medium text-[30px] font-['Inter'] drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                {skill.name}
              </h3>
            </motion.div>
          ))}

        ...
        <div className="mt-16 flex flex-wrap justify-center gap-6">
          {skillsList.map((skill, idx) => (
            <motion.div
              ...
              className="group flex flex-col items-center justify-center gap-3 w-[150px] h-[140px] p-4 bg-white/[0.01] backdrop-blur-2xl backdrop-saturate-[1.8] rounded-2xl shadow-glass cursor-default relative overflow-hidden shadow-[inset_0px_1px_1px_rgba(255,255,255,0.2)] before:absolute before:inset-0 before:rounded-2xl before:border before:border-transparent before:bg-gradient-to-b before:from-white/40 before:to-transparent before:[-webkit-mask-image:linear-gradient(#fff_0_0),linear-gradient(#fff_0_0)] before:[-webkit-mask-clip:padding-box,border-box] before:[-webkit-mask-composite:destination-out] before:[mask-composite:exclude]"
            >
